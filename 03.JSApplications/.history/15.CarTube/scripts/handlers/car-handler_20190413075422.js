handlers.getAllCars = function(ctx) {
    ...
    ctx.id = sessionStorage.getItem('_id');
    ctx.isCreator = sessionStorage.getItem('isCreator') == ctx.id;
    console.log(ctx.isCreator);
    ...
    ctx.loadPartials({
        ...
        .then(function() {
            ...
            this.partial('./templates/pet/car-listing.hbs')
        })
